const SUPPORTED_TYPES = {
  ...
  STRINGARRAY: {
    isTypeFromArgument: (arg) => {
      ...
      const findNonString = arg.some(value => typeof value !== 'string');
      if(findNonString) return false;
    ...
    getRef: (wasmExports, arg) => {
      return wasmExports.__retain(wasmExports.__allocArray(wasmExports.__asbind_StringArray_ID, arg));
    },
    getValueFromRef: (wasmExports, responseRef) => {
